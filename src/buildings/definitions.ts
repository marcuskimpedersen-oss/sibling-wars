...
export const RACE_ACADEMIES: Record<Race, BuildingDef> = {
  architects: {
    ...
    description: 'Research weapon/armor upgrades and unit abilities. Requires Pylon power.',
    textureKey: 'building_research_array', tileWidth: 2, tileHeight: 2,
    goldCost: 125, maxHealth: 338, supplyProvided: 0, isHQ: false,
    tint: RACE_TINTS.architects, requiresPower: true,
    produces: [
      ...UPGRADE_PRODUCES,
      { id: 'unlock_overcharge', name: 'Overcharge Protocol', goldCost: 150, productionMs: 20000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Overcharge for Riflemen — temporarily doubles attack speed.', isUpgrade: true },
    ],
  },
  covenant: {
    id: 'sacred_archive', name: 'Sacred Archive',
    description: 'Research weapon/armor upgrades and unit abilities.',
    textureKey: 'building_sacred_archive', tileWidth: 2, tileHeight: 2,
    goldCost: 125, maxHealth: 338, supplyProvided: 0, isHQ: false,
    tint: RACE_TINTS.covenant,
    produces: [
      ...UPGRADE_PRODUCES,
      { id: 'unlock_divine_pulse', name: 'Divine Pulse Rite', goldCost: 150, productionMs: 20000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Divine Pulse for Devotees — heals all nearby allies.', isUpgrade: true },
      { id: 'unlock_holy_nova',   name: 'Holy Nova Rite',   goldCost: 200, productionMs: 25000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Holy Nova for Devotees — massive AoE heal burst.', isUpgrade: true, prerequisite: 'unlock_divine_pulse' },
    ],
  },
  bulwark: {
    id: 'iron_forge', name: 'Iron Forge',
    description: 'Research weapon/armor upgrades and unit abilities.',
    textureKey: 'building_iron_forge', tileWidth: 2, tileHeight: 2,
    goldCost: 125, maxHealth: 338, supplyProvided: 0, isHQ: false,
    tint: RACE_TINTS.bulwark,
    produces: [
      ...UPGRADE_PRODUCES,
      { id: 'unlock_shield_wall', name: 'Shield Wall Training', goldCost: 150, productionMs: 20000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Shield Wall for Ironclad units — temporary damage immunity.', isUpgrade: true },
    ],
  },
  unseen: {
    id: 'shadow_academy', name: 'Shadow Academy',
    description: 'Research weapon/armor upgrades and Phantom abilities.',
    textureKey: 'building_shadow_academy', tileWidth: 2, tileHeight: 2,
    goldCost: 125, maxHealth: 338, supplyProvided: 0, isHQ: false,
    tint: RACE_TINTS.unseen,
    produces: [
      ...UPGRADE_PRODUCES,
      { id: 'unlock_stealth',       name: 'Shadow Veil',       goldCost: 125, productionMs: 18000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Stealth for Phantoms — go invisible until attacking.', isUpgrade: true },
      { id: 'unlock_shadow_clone',  name: 'Mirror Technique',  goldCost: 150, productionMs: 22000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Shadow Clone for Phantoms — spawn a decoy to confuse enemies.', isUpgrade: true, prerequisite: 'unlock_stealth' },
      { id: 'unlock_phase_shift',   name: 'Phase Shift Mastery', goldCost: 200, productionMs: 28000, supplyUsed: 0, textureKey: 'unit', speed: 0, description: 'Unlocks Phase Shift for Phantoms — become intangible for 3 seconds.', isUpgrade: true, prerequisite: 'unlock_shadow_clone' },
    ],
  },
};
...
export const RACE_HOUSES: Record<Race, BuildingDef> = {
  architects: {
    ...
    textureKey: 'building_habitat_module',
    tileWidth: 2, tileHeight: 2,
  ...
  covenant: {
    ...
    textureKey: 'building_commune_hall',
    tileWidth: 2, tileHeight: 2,
    goldCost: 75, maxHealth: 338, supplyProvided: 10,
  ...
  bulwark: {
    ...
    textureKey: 'building_fortified_quarters',
    tileWidth: 2, tileHeight: 2,
  ...
  unseen: {
    ...
    textureKey: 'building_safe_house',
    tileWidth: 2, tileHeight: 2,
...
export const UNSEEN_SHADE_SPIRE_DEF: BuildingDef = {
  ...
  textureKey: 'building_shade_spire',
  tileWidth: 2, tileHeight: 2,
...
export const UNSEEN_VOID_CITADEL_DEF: BuildingDef = {
  ...
  textureKey: 'building_void_citadel',
  tileWidth: 2, tileHeight: 2,
...
export const COVENANT_WELLSPRING_DEF: BuildingDef = {
  ...
  textureKey: 'building_wellspring',
  tileWidth: 2, tileHeight: 2,
...
export const BULWARK_WALL_DEF: BuildingDef = {
  ...
  textureKey: 'building_bulwark_wall',
...
export const COVENANT_SHRINE_OF_UNITY_DEF: BuildingDef = {
  ...
  textureKey: 'building_shrine_of_unity',
  tileWidth: 2, tileHeight: 2,
...
export const ARCHITECTS_FABRICATION_HALL_DEF: BuildingDef = {
  ...
  textureKey: 'building_fabrication_hall',
  tileWidth: 2, tileHeight: 2,
...
export const ARCHITECTS_SENTINEL_TURRET_DEF: BuildingDef = {
  ...
  textureKey: 'building_sentinel_turret',
  tileWidth: 1, tileHeight: 1,
...
export const BULWARK_GARRISON_POST_DEF: BuildingDef = {
  ...
  textureKey: 'building_garrison_post',
  tileWidth: 2, tileHeight: 2,
  ...
  architects: [
    {
      ...
      textureKey: 'building_command_nexus',
    ...
    },
    {
      ...
      textureKey: 'building_tech_foundry',
      tileWidth: 2, tileHeight: 2,
  ...
  covenant: [
    {
      ...
      textureKey: 'building_sacred_spire',
      tileWidth: 3, tileHeight: 3,
  ...
  bulwark: [
    {
      ...
      textureKey: 'building_iron_bastion',
      tileWidth: 3, tileHeight: 3,
  ...
  unseen: [
    {
      ...
      textureKey: 'building_shadow_node',
      tileWidth: 3, tileHeight: 3,
    ...
    },
    {
      ...
      textureKey: 'building_infiltration_den',
      tileWidth: 2, tileHeight: 2,
      goldCost: 125, maxHealth: 270, supplyProvided: 0,
      isHQ: false, tint: RACE_TINTS.unseen,
      produces: [
...
export function getBuildingsForRace(race: Race): BuildingDef[] {
  ...
  const shrineBuildingDef: BuildingDef = {
    ...
    textureKey: `building_${shrine.id}`,
    tileWidth: 2, tileHeight: 2,
